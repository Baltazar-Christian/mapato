            ...
            <tr>
              ...
              <td>
                  <div class="text-center">
                      <a class="btn btn-sm bg-navy p-1" href="EditDebt.php?id=<?php echo $row['id'];?>"><i class="fa fa-pen "></i></a>
                      <a class="btn btn-sm  bg-danger p-1" href="config/DeleteDebt.php?id=<?php echo $row['id'];?>"><i class="fa fa-trash "></i></a>
                  </div>
              </td>
            </tr>
            <?php 
